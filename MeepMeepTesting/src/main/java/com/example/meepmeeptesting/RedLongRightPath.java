...
public class RedLongRightPath {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(-35.2, -63.2, Math.PI/2))
                ...
                //Spike mark RIGHT
                .lineToYSplineHeading(-43,Math.PI/3+0.25)
                .splineToLinearHeading(new Pose2d(-31,-35,Math.PI/4),0)
                ...
                //Go to leaving spot
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(-35.4,-58.9),0)
                ...
                .setReversed(true)
                .splineToSplineHeading(new Pose2d(48.4,-40.4,-1e-6),0.50)
                ...
                .setReversed(true)
                .splineToSplineHeading(new Pose2d(13,-58.9,-Math.PI),Math.PI)  // 4.3 // tangent: Math.PI works reeeealy well
                ...
                //Spline to Backboard on the RIGHT side(closer to us so It's faster)
                .setReversed(true)
                .splineToSplineHeading(new Pose2d(48.4,-40.4,0),0.50)
