//// DETECT BLUE BLOB OF MAXIMUM AREA ON SCREEN BETWEEN lower and higher HSV
...
public class DetectBlueBlob implements VisionProcessor {
    Telemetry telemetry;
    Mat hsvMat = new Mat();
    Mat mask = new Mat();
    ...
    public DetectBlueBlob(Telemetry telemetry) {
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        Scalar lowerRed = new Scalar(105, 60, 70); // Lower bound of HSV(Hue,Saturation,Value) for blue 110 60 80
        Scalar upperRed = new Scalar(140, 255, 255); // Upper bound of HSV(Hue,Saturation,Value) for blue
